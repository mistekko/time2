...
(defun time2 (command &optional (times 20) (interval 0) (ignore-shell-error nil))
...
If `ignore-shell-error' is non-nil time2 accumulates the times of
executions which result in non-zero exit codes. Otherise time2 exits
on such occasions."
...
(defun main ()
  "Entrypoint for command-line-invocation of time2."
